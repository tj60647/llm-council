...
export function stage3ChairmanPrompt(userQuery, stage1Text, stage2Text) {
    return `You are the Chairman of an LLM Council. Multiple AI models have provided responses and ranked each other.\n\nOriginal Question: ${userQuery}\n\nSTAGE 1 - Responses:\n${stage1Text}\n\nSTAGE 2 - Peer Rankings:\n${stage2Text}\n\nTask: Synthesize a single comprehensive, accurate answer representing collective wisdom:`;
}
...
export const PROMPT_TEMPLATES = [
    ...
    },
    {
        ...
        appliesTo: 'seat 1 only (the chairman)',
        summary: 'The chairman sees every answer with model names attached plus every peer ranking, and writes the final answer.',
        template: stage3ChairmanPrompt('{your question}', '{all Stage 1 answers, attributed}', '{all Stage 2 rankings}')
    }
];
